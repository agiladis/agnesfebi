        ...
        <div id="content">
            <div class="landing-page">
                ...
                <div class="landpage-caption text-center pt-3 overflow-x-hidden" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="1300">
                    ...
                    <p class="font-alexBrush m-0 text-size-xl" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="1800">Agnes</p>
                    <h1 class="font-alexBrush m-0">&</h1>
                    <p class="font-alexBrush m-0 text-size-xl" data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-duration="1800">Febri</p>
                ...
                <div class="container-couple overflow-x-hidden">
                    <div class="couple-half" data-aos="fade-left" data-aos-easing="ease-in-sine" data-aos-duration="1000">
                        ...
                        <div class="desc-groom">
                            ...
                            <p class="text-secondary">Agnesia Leony Meidyna Lestari</p>
                            <p>
                                <small><i>Putri Kedua Dari</i></small>
                                <br>
                                Bapak Poerwanto Asmoro, S.H (Alm) &
                                <br>
                                Ibu Ir. Dewiyah Permedy
                            </p>
                        </div> <!-- end desc-groom -->
                    </div> <!-- end couple-half -->
                    <div class="m-auto">
                    ...
                    <div class="couple-half text-right" data-aos="fade-right" data-aos-easing="ease-in-sine" data-aos-duration="1000">
                        <div class="desc-groom">
                            <h1 class="font-alexBrush m-0">Febri</h1>
                            <p class="text-secondary">Rio Mardani</p>
                            <p>
                                <small><i>Putra Ketiga Dari</i></small>
                                <br>
                                Bapak Mulyanto &
                                <br>
                                Ibu Endang Murniati
            ...
            <div class="container schedule-container">
                ...
                <div class="location d-flex flex-column col-md-8 mb-5" data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="800">
                    ...
                    <div>Raja Sunda Wedding Hall and Resto Jl. Jendral Sudirman KM. 34, No. 1, Bekasi Barat, Medan Satria RT001/RW017, Harapan Mulya, Kecamatan Medan Satria, Kota Bekasi, Jawa Barat 17143</div>
                </div> <!-- end location -->
                <div class="mb-5 text-center" data-aos="zoom-in-up" data-aos-easing="ease-in-sine" data-aos-duration="800">
                    <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1ziz4g-7vHFHc5soVPgZot4Jb9xxw9vHm" class="mb-4"></iframe>
            ...
            <div class="countdown-container">
                <div class="container">
                    <h1 class="text-center font-alexBrush" data-aos="zoom-in-down" data-aos-easing="ease-in-sine" data-aos-duration="1000">Countdown</h1>
                    ...
                    <img src="./img/bg_countdown.jpg" alt="">
            ...
            <div class="container">
                ...
                <div class="qrcode-container">
                    <div class="ovo" data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="600">
                        ...
                        <a href="./img/bca.jpeg" data-lightbox="OVO" data-title="QR Code OVO" style="cursor: pointer; outline: 20px;">
                            <img src="./img/bca.jpeg" alt="BCA">
                        </a>
                    </div>
                    <div class="dana" data-aos="fade-up" data-aos-easing="ease-in-sine" data-aos-duration="600">
                        <h5 class="text-center">DANA</h5>
                        <a href="./img/dana.jpeg" data-lightbox="DANA" data-title="QR Code DANA" style="cursor: pointer; outline: 20px;">
